...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      name: "Email",
      icon: Mail,
      url: "mailto:anjanapinnawala22@gmail.com",
    ...
    >
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          {/* Section Title */}
          <h2
            className={`text-5xl font-bold mb-8 transition-all duration-700 ${
          ...
          {/* Section Description */}
          <p
            className={`text-xl text-white mb-12 transition-all duration-700 delay-150 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            {socialLinks.map((link, index) => {
              ...
              return (
                ...
                >
                  {/* Overlay */}
                  <div className="absolute inset-0 bg-gradient-to-br from-primary to-accent rounded-2xl blur-lg opacity-0 group-hover:opacity-75 transition-opacity duration-300 pointer-events-none" />
